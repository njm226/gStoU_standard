...
if mode == 0:
    ...
    with open('state_g_1x_standard_StoU.txt', 'wb') as F:
        ...
        # save state_list
    with open('state_g_1x075_standard_StoU.txt', 'wb') as F:
          pickle.dump(state_list, F)

elif mode == 3:
        # save state_list
    with open('state_g_1x05_standard_StoU.txt', 'wb') as F:
          pickle.dump(state_list, F)
          
elif mode == 4:
        # save state_list
    with open('state_g_1x025_standard_StoU.txt', 'wb') as F:
          pickle.dump(state_list, F)
...
if mode == 0:
    ...
    # save Timing list
    with open('b_list_1x_S20_standard_StoU.txt', 'wb') as F:
        pickle.dump(b_value_list, F)
    ...
    # save Timing list
    with open('b_list_1x075_S20_standard_StoU.txt', 'wb') as F:
        pickle.dump(b_value_list, F)
    ...
    # save Timing list
    with open('b_list_1x05_S20_standard_StoU.txt', 'wb') as F:
        pickle.dump(b_value_list, F)
    ...
    # save Timing list
    with open('b_list_1x025_S20_standard_StoU.txt', 'wb') as F:
        pickle.dump(b_value_list, F)
