...
import smaller_StoU
import importlib
importlib.reload(smaller_StoU)
from smaller_StoU import t_loop
#import pandas as pd
...
def simple_small(X_Y):
    ...
    #start the loop
    Max_blue, Max_red, states = t_loop(duration, mt_region, positions, rates, global_mode)
    #print(states)
