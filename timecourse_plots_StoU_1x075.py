...
if mode == 1:
    # save state_list
    with open('cenH_small_1x_gAtoU70_UtoM80_S90.txt', 'wb') as F:
        pickle.dump(cenH_total_small, F)
        
    # save state_list
    with open('cenH_m_1x_gAtoU70_UtoM80_S90.txt', 'wb') as F:
        pickle.dump(cenH_total_m, F)
        
    # save state_list
    with open('cenH_large_1x_gAtoU70_UtoM80_S90.txt', 'wb') as F:
      pickle.dump(cenH_total_large, F)
        
    # save state_list
    with open('cenH_max_1x_gAtoU70_UtoM80_S90.txt', 'wb') as F:
    ...
    # save state_list
    with open('EcoRV_small_1x_gAtoU70_UtoM80_S90.txt', 'wb') as F:
        pickle.dump(EcoRV_total_small, F)
        
    # save state_list
    with open('EcoRV_m_1x_gAtoU70_UtoM80_S90.txt', 'wb') as F:
        pickle.dump(EcoRV_total_m, F)
        
    # save state_list
    with open('EcoRV_large_1x_gAtoU70_UtoM80_S90.txt', 'wb') as F:
        pickle.dump(EcoRV_total_large, F)
        
    # save state_list
    with open('EcoRV_max_1_gAtoU70_UtoM80_S90.txt', 'wb') as F:
        pickle.dump(EcoRV_total_max, F)
        

elif mode == 2:
    # save state_list
    with open('cenH_small_1x075_gAtoU80_UtoM80_S250.txt', 'wb') as F:
        pickle.dump(cenH_total_small, F)
        
    # save state_list
    with open('cenH_m_1x075_gAtoU80_UtoM80_250.txt', 'wb') as F:
        pickle.dump(cenH_total_m, F)
        
    # save state_list
    with open('cenH_large_1x075_gAtoU80_UtoM80_S250.txt', 'wb') as F:
      pickle.dump(cenH_total_large, F)
        
    # save state_list
    with open('cenH_max_1x075_gAtoU80_UtoM80_S250.txt', 'wb') as F:
        pickle.dump(cenH_total_max, F)
    ...
    # save state_list
    with open('EcoRV_small_1x075_gAtoU80_UtoM80_S250.txt', 'wb') as F:
        pickle.dump(EcoRV_total_small, F)
        
    # save state_list
    with open('EcoRV_m_1x075_gAtoU80_UtoM100_S80.txt', 'wb') as F:
        pickle.dump(EcoRV_total_m, F)
        
    # save state_list
    with open('EcoRV_large_1x075_gAtoU80_UtoM80_S250.txt', 'wb') as F:
        pickle.dump(EcoRV_total_large, F)
        
    # save state_list
    with open('EcoRV_max_1x075_gAtoU80_UtoM80_S250.txt', 'wb') as F:
        pickle.dump(EcoRV_total_max, F)
...
if mode == 1:
    ...
    plt.savefig("timecourse_075x_gAtoU80_UtoM80_S250.pdf")
